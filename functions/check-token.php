...
function checkToken(&$response, &$dbManager) {
    $isValid = false;
    $response = array('success'=>false, 'status'=>401, 'message'=>getStringInLang('response-messages', 2).getStringInLang('response-messages', 3).getStringInLang('response-messages', 6));
