...
<form method="post">
    ...
    <div style="border:solid 0.1em;float:left;margin-bottom:1em">
        <div style="float:left;margin:1em 0 0 0.5em">
        ...
        <div style="float:left;margin:0.5em 0.5em 1em;width:100%">
