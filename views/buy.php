...
<?php if ($response['status']==404): ?>
    ...
    <p class="one-column-row"><?php echo getStringInLang('commons', 6); ?><a href="<?php echo WEB_BASE_DIR; if (CLEAN_URLS): echo getStringInLang('commands', 1).'-'.getStringInLang('snack', 2); else: echo 'index.php?view='.getStringInLang('commands', 1).'-'.getStringInLang('snack', 2); endif; ?>" title="<?php echo getStringInLang('add-snack', 1); ?>"><b><?php echo strtoupper(getStringInLang('commands', 1)); ?></b></a><?php echo getStringInLang('commons', 7) ?></p>
<?php elseif ($response['status']==200 || $response['status']==400): ?>
	<form id="buy-form" class="row" method="post">
        ...
        <div class="row">
            ...
            <div class="column">
                <label for="quantity-input"><?php echo getStringInLang('buy', 2); ?></label>
        ...
        <div class="one-column-row">
            <label for="customise-buy-options-input"><?php echo getStringInLang('buy', 3); ?></label>
        ...
        <div id="buy-options" class="options row">
            <div class="first-row last-row">
                ...
                <div class="column">
                    <label for="expiration-input"><?php echo getStringInLang('snack', 5); ?></label>
        ...
        <input class="one-column-last-row" type="submit" value="<?php echo ucfirst(getStringInLang('commands', 5)); ?>">
	</form>
	<script>
        ...
        var translatedStrings = [
            ...
            "<?php echo getStringInLang('buy', 5); ?>",
            "<?php echo getStringInLang('buy', 4); ?>",
            "<?php echo ucfirst(getStringInLang('commands', 5)); ?>",
            "<?php echo getStringInLang('buy', 6); ?>",
            "<?php echo ucfirst(getStringInLang('snack', 3)); ?>",
            "<?php echo ucfirst(getStringInLang('snack', 4)); ?>",
            "<?php echo getStringInLang('snack', 5); ?>"
        ];
	</script>
