...
<form class="row" method="post">
    ...
    <div class="one-column-row">
        ...
        <input type="password" name="password" id="password-input" placeholder="<?php echo getStringInLang('user', 4); ?>" value="<?php if (isset($_POST['password'])) {echo $_POST['password'];} ?>" maxlength="125" required>
    </div>
