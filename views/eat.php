...
<?php endif; if ($response['status']==404 && $commandName=='get-to-eat-and-user-funds'): ?>
    ...
    <p class="one-column-row"><?php echoTranslatedString('commons', '6'); ?><a href="<?php echo BASE_DIR; if (CLEAN_URLS): echoTranslatedString('commands', 5); else: echo 'index.php?view='.getTranslatedString('commands', 5).'&command-name=get-to-buy'; endif; ?>" title="<?php echoTranslatedString('buy', 1); ?>"><strong><?php echoStrtoupperTranslatedString('commands', 5); ?></strong></a><?php echoTranslatedString('commons', 7) ?></p>
