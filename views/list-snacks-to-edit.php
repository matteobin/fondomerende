...
<?php else: ?>
    ...
    <li><?php echo $snack['friendly-name']; ?> <?php if ($snack['visible']==0): echo ' ('.getTranslatedString('snack', 7).')'; endif; ?></h3> <a href="<?php echo BASE_DIR; ?>index.php?view=edit-snack&command-name=get-snack-data&name=<?php echo $snack['name']; ?>"><?php echoStrtoupperTranslatedString('commands', '2'); ?></a>
        <ul>
