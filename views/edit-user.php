...
<form id="edit-user-form" class="row" method="post">
    ...
    <div class="one-column-row">
        <label for="password-input"><?php echo getTranslatedString('edit-user', 2); ?> <?php echo getTranslatedString('user', 3); ?></label>
        <input type="password" name="password" id="password-input" placeholder="<?php echo getTranslatedString('user', 4); ?>" maxlength="125" value="<?php if (isset($_POST['password'])) {echo $_POST['password'];} ?>">
    </div>
    <div class="one-column-row">
        <label for="current-password-input"><?php echo getTranslatedString('edit-user', 3); ?> <?php echo getTranslatedString('user', 3); ?> <?php echo getTranslatedString('edit-user', 4); ?></label>
        <input type="password" name="current-password" id="current-password-input" placeholder="<?php echo getTranslatedString('edit-user', 5); ?>" maxlength="125" required>
    </div>
