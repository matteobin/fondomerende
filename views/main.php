<?php 
    ...
    if (FRIENDLY_URLS) {
        $hrefs = array(BASE_DIR.getTranslatedString('commands', 3), BASE_DIR.getTranslatedString('commands', 1).'-'.getTranslatedString('snack', 2), BASE_DIR.getTranslatedString('commands', 4), BASE_DIR.getTranslatedString('commands', 5), BASE_DIR.getTranslatedString('commands', 4), BASE_DIR.getTranslatedString('commands', 2).'-'.getTranslatedString('user', 1), BASE_DIR.getTranslatedString('snack', 1), BASE_DIR.getTranslatedString('actions', 1).'/25/1', BASE_DIR.getTranslatedString('login', 1), BASE_DIR.getTranslatedString('credits', 1));
    } else {
