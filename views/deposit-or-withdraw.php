...
<?php endif; if ($response['status']==404 && !isset($response['message'])): ?>
    ...
    <p class="one-column-row"><?php echoTranslatedString('commons', '6'); ?><a href="<?php echo BASE_DIR; if (FRIENDLY_URLS): echoTranslatedString('commands', 3); else: echo 'index.php?view='.getTranslatedString('commands', 3).'&command-name=get-user-funds'; endif; ?>"><strong><?php echoStrtoupperTranslatedString('commands', 3); ?></strong></a><?php echoTranslatedString('commons', 7) ?></p>
<?php else: ?>
